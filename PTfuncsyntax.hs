...
windChillRisk t v
 | 35.74 + 0.6215*t - 35.75*v**0.16 + 0.4275*t*v**0.16 < -64 = "Extreme Risk"
 | 35.74 + 0.6215*t - 35.75*v**0.16 + 0.4275*t*v**0.16 < -53 = "Severe Risk"
 | 35.74 + 0.6215*t - 35.75*v**0.16 + 0.4275*t*v**0.16 < -38 = "Very High Risk"
 | 35.74 + 0.6215*t - 35.75*v**0.16 + 0.4275*t*v**0.16 < -17 = "High Risk"
 | 35.74 + 0.6215*t - 35.75*v**0.16 + 0.4275*t*v**0.16 < 16 = "Moderate Risk"
 | otherwise = "Low Risk"

--35.74 + 0.6215*Ta - 35.75*v**0.16 + 0.4275*Ta*v**0.16
...
yoCount ('y':'o':s) = yoCount s + 1 -- a string starting with "yo". What to do here?
yoCount ('Y':'o':s) = yoCount s + 1 -- a string starting with "Yo". What to do here?
